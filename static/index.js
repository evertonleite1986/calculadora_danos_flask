...
function calcularDano() {
    if (!personagemSelecionado || !armaSelecionada) {
        alert('Selecione o personagem e o ataque para calcular o dano');
        return;
    }
    ...
    if (danoTotal >= vidaPersonagem) {
        resultado += alert('Muito bem!! Você acabou com o ' + personagemSelecionado);
    } else {
        resultado += alert('Oh não, ainda não conseguiu, tente novamente!');
    }
}
